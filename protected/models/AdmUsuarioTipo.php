...
/**
 * This is the model class for table "adm_usuario_tipo".
 *
 * The followings are the available columns in table 'adm_usuario_tipo':
 * @property integer $id
 ...
 */
class AdmUsuarioTipo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'admUsuarios' => array(self::HAS_MANY, 'AdmUsuario', 'id_usuario_tipo'),
		);
	}
	 ...
	 * @return AdmUsuarioTipo the static model class
	 */
