...
$('.search-form form').submit(function(){
	$('#adm-usuario-tipo-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
                        ...
                        <div class="simplebox grid740" style="padding: 20px 24px;">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display data-table" id="example" >
                                ...
                                <tbody></div>
									...
									<?php  	} ?>
													<td>
														<a class="view" title="View" href="<?php  echo $base_url;?>/AdmUsuarioTipo/<?php  echo $result->id; ?>"><img src="<?php  echo $base_url;?>/assets/1a126bf3/gridview/view.png" alt="Ver" /></a>
														<a class="update" title="Update" href="<?php  echo $base_url;?>/AdmUsuarioTipo/update/<?php  echo $result->id; ?>"><img src="<?php  echo $base_url;?>/assets/1a126bf3/gridview/update.png" alt="Alterar" /></a>
                	...
                	<script type="text/javascript">
						function apagar(id){
							...
							if(conf)
								$.post("<?php   echo $base_url;?>/AdmUsuarioTipo/delete",
									    {
									        'id': id
									    },
									    function(result){
									        ...
									        if(result.status){
										        window.location = "<?php   echo $base_url;?>/AdmUsuarioTipo/admin";
									        }
									        else
										        alert(result.msg);
									    });
